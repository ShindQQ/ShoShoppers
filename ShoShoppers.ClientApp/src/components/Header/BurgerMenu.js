export const BurgerMenu = ({ setState, state }) => {
    return (
        <button className="btn-icon flex justify-center items-center h-full" onClick={() => setState(!state)}>
            <svg className="h-11 text-black" fill="currentColor" viewBox="0 0 24 22" aria-hidden="true">
