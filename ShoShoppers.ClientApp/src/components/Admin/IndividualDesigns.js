...
const IndividualDesignFilter = props => (
    <Filter {...props} >
...
export const IndividualDesignList = props => {
    return (
        <List {...props} filters={<IndividualDesignFilter />} sort={{ field: 'id', order: 'ASC' }}>
            <Datagrid>
...
export const IndividualDesignEdit = props => {
    return (
        <Edit {...props} mutationMode="pessimistic">
            <SimpleForm>
                ...
                <NumberInput source="itemAmmount" defaultValue={-1} />
                <BooleanInput source="itemInProduction" defaultValue={true} />
            </SimpleForm>
        </Edit>
    );
}

export const IndividualDesignCreate = props => {
    return (
        <Create {...props}>
            <SimpleForm>
                <TextInput source="name" fullWidth multiline />
