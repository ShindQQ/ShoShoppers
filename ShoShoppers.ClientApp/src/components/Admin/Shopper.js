...
export const ShopperList = props => {
    return (
        <List {...props} filters={<ShopperFilter />} sort={{ field: 'id', order: 'ASC' }}>
            <Datagrid>
                ...
                <TextField label="ImageColor" source="imageColor" />
    ...
    return (
        <Edit {...props} mutationMode="pessimistic">
            <SimpleForm>
                ...
                <TextInput label="Color" source="color" fullWidth multiline />
                <TextInput label="ImageColor" source="imageColor" fullWidth multiline />
...
export const ShopperCreate = props => {
    return (
        <Create {...props}>
            <SimpleForm>
                <TextInput source="name" fullWidth multiline />
